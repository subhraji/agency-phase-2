...
import com.example.agencyphase2.model.repository.GetAllChatRepository
...
class GetAllChatViewModel @Inject constructor(private val repository: GetAllChatRepository) : ViewModel() {
    ...
    val response: LiveData<Outcome<GetChatResponse?>?> = _response
    ...
    fun getAllChat(
        ...
        repository.getAllChat(token, job_id, page).onStart {
