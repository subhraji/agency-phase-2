...
class JobPostFragment : Fragment() {
    ...
    private fun setCareTypeSpinner(){
        val arrayAdapter = ArrayAdapter(requireActivity(), android.R.layout.simple_spinner_dropdown_item,careTypeList)
            ...
            when(outcome){
                is Outcome.Success ->{
                    ...
                    if(outcome.data?.success == true){
                        ...
                        val intent = Intent(requireActivity(), PostJobPreviewActivity::class.java)
